...
def test_users_table_seeded_correctly() -> None:
...
def test_sessions_table_seeded_correctly() -> None:
    db = DatabaseConnection()
    db.connect()
    db.seed("./db/schema.sql")
    db.execute("INSERT INTO users (username, password) VALUES ('jake', 'password');")
...
def test_apiaries_table_seeded_correctly() -> None:
    db = DatabaseConnection()
    db.connect()
    db.seed("./db/schema.sql")
    db.execute("INSERT INTO users (username, password) VALUES ('jake', 'password');")
...
def test_hives_table_seeded_correctly() -> None:
    db = DatabaseConnection()
    db.connect()
    db.seed("./db/schema.sql")
    db.execute("INSERT INTO users (username, password) VALUES ('jake', 'password');")
...
def test_colonies_table_seeded_correctly() -> None:
    db = DatabaseConnection()
    db.connect()
    db.seed("./db/schema.sql")
    db.execute("INSERT INTO users (username, password) VALUES ('jake', 'password');")
...
def test_queens_table_seeded_correctly() -> None:
    db = DatabaseConnection()
    db.connect()
    db.seed("./db/schema.sql")
    db.execute("INSERT INTO users (username, password) VALUES ('jake', 'password');")
...
def test_inspections_table_seeded_correctly() -> None:
    db = DatabaseConnection()
    db.connect()
    db.seed("./db/schema.sql")
    db.execute("INSERT INTO users (username, password) VALUES ('jake', 'password');")
...
def test_observations_table_seeded_correctly() -> None:
    db = DatabaseConnection()
    db.connect()
    db.seed("./db/schema.sql")
    db.execute("INSERT INTO users (username, password) VALUES ('jake', 'password');")
...
def test_actions_table_seeded_correctly() -> None:
    db = DatabaseConnection()
    db.connect()
    db.seed("./db/schema.sql")
    db.execute("INSERT INTO users (username, password) VALUES ('jake', 'password');")
    ...
    assert results == [{"action_id": 1, "notes": "Added some feed", "inspection_id": 1}]
